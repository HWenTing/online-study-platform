...
public class TestVod {
    ...
    public void testGetPlayInfo() throws ClientException {
        //初始化客户端、请求对象和相应对象
        DefaultAcsClient client = InitObject.initVodClient("aliyunossfilekeyid","aliyunossfilekeysecret");
        ...
        try {
            //设置请求参数
            //注意：这里只能获取非加密视频的播放地址
            request.setVideoId("eda147279e5048ecb0014e9388c662b6");
            //获取请求响应
    ...
    public void testUploadVideo(){
        ...
        //文件名必须包含扩展名
        String fileName = "E:\\学习\\尚硅谷\\guli\\项目资料\\1-阿里云上传测试视频\\haha.mp4";
        //本地文件上传
        UploadVideoRequest request = new UploadVideoRequest("aliyunossfilekeyid",
                "aliyunossfilekeysecret", title, fileName);
